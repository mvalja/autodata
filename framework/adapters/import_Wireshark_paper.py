...
"""
##reslist=paperRUN.readMyCSV('F:\ongoingWork\FOI\pcap\snart-fw.cleanfurnace1.se\psml\pcap_02.csv', ',', False)
reslist=readFile("F:\ongoingWork\FOI\pcap\snart-fw.cleanfurnace1.se\psml\pcap_02.xml")
newset=set()
for r in reslist:
	newset.add((r[0],r[1],r[2]))
print(len(newset))
#pprint(newset)
"""
